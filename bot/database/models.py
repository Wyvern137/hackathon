...
class NKOProfile(Base):
    ...
    tone_of_voice: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)  # Тон голоса (ToneOfVoice)
...
class ContentHistory(Base):
    ...
    content_type: Mapped[str] = mapped_column(String(20))  # Тип контента (ContentType)
...
class TeamMember(Base):
    ...
    role: Mapped[str] = mapped_column(String(20))  # Роль в команде (TeamRole)
